...
document.getElementById('predictorForm').addEventListener('submit', function(event) {
    ...
    const weight = document.getElementById('weight').value;
    const trainingHours = document.getElementById('trainingHours').value;
    const fatigueScore = document.getElementById('fatigueScore').value;
    const loadBalanceScore = document.getElementById('loadBalanceScore').value;
    const aclRiskScore = document.getElementById('aclRiskScore').value;
    const injuryIndicator = document.getElementById('injuryIndicator').value;
